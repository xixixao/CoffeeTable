...
BSOMetaParser = subclass(BSDentParser, {
    ...
    "hostExpr": function () {
        var r;
        return (function () {
            r = this._applyWithArgs("foreign", BSJSParser, 'expr');
    ...
    "closedHostExpr": function () {
        var r;
        return (function () {
            r = this._applyWithArgs("foreign", BSSemActionParser, 'delimSemAction');
            return this._applyWithArgs("foreign", BSJSTranslator, 'trans', r)
        }).call(this)
    },
    "openHostExpr": function () {
        ...
        return (function () {
            ...
            r = this._applyWithArgs("foreign", BSSemActionParser, 'semAction', p);
            return this._applyWithArgs("foreign", BSJSTranslator, 'trans', r)
        }).call(this)
    },
    "semAction": function () {
