...
BSJSParser = OMeta.interpreters.BSJSParser;
BSSemActionParser = OMeta.interpreters.BSSemActionParser;
BSJSTranslator = OMeta.interpreters.BSJSTranslator;
...
"hostExpr":function(){var r;return r=this._applyWithArgs("foreign",SemActionParser,'simpleExp',this.locals.values())},
"closedHostExpr":function(){var r;return r=this._applyWithArgs("foreign",SemActionParser,'delimSemAction',this.locals.values())},
"openHostExpr":function(){var p,r;return (function(){p=this._apply("anything");return r=this._applyWithArgs("foreign",SemActionParser,'semAction',p,this.locals.values())}).call(this)},
...
"grammar":function(){var ss,ip,n,sn,p,r,rs;return (function(){ip=(function(){ss=this._many((function(){return this._apply("inspace")}));return ss.length}).call(this);this._applyWithArgs("keyword",'ometa');n=this._apply("name");sn=this._or((function(){return (function(){this._applyWithArgs("keyword",'extends');return this._apply("name")}).call(this)}),(function(){return (function(){this._apply("empty");return 'OMeta'}).call(this)}));this._applyWithArgs("moredent",ip);p=this._apply("linePos");r=this._apply("rule");rs=this._many((function(){return (function(){this._applyWithArgs("nodent",p);return this._apply("rule")}).call(this)}));this._applyWithArgs("lessdent",ip);return this._applyWithArgs("foreign",BSOMetaOptimizer,'optimizeGrammar',['Grammar', n, sn, r].concat(rs))}).call(this)}});
