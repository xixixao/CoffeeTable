...
var AbstractGrammar = exports.AbstractGrammar = ometajs.grammars.AbstractGrammar;

var BSJSParser = ometajs.grammars.BSJSParser;

var BSJSIdentity = ometajs.grammars.BSJSIdentity;

var BSJSTranslator = ometajs.grammars.BSJSTranslator;
...
util.inherits(BSJSParser, AbstractGrammar);
...
util.inherits(BSSemActionParser, BSJSParser);
...
util.inherits(BSJSIdentity, AbstractGrammar);
...
util.inherits(BSJSTranslator, AbstractGrammar);
